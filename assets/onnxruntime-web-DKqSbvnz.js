...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Jl=(e,t)=>new _s(e,t),Qt=(e,t)=>{let r=e.length,i=[];for(let a=0;a<r;a++){let n=r-1-a,s=e[n]||1;(t[t.length-1-a]||1)>1&&s===1&&i.unshift(n)}return i}}),vs,bi,xs,Ss,ks,Ze,ed,td,Pt=M(()=>{Y(),te(),be(),re(),vs=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},bi=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,xs=(e,t)=>O.sortBasedOnPerm(e,bi(e.length,t)),Ss=(e,t,r,i)=>{let a=[];a.push(`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${i}_${s}`,inputDependencies:p?["rank","type","type","type","type"]:void 0},getShaderSource:b,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:p?[{type:12,data:d},...j(n)]:[{type:12,data:d}]})}},eo=e=>ce(e),kd=(e,t)=>{let{inputs:r,outputCount:i}=e,a=eo({...t,outputCount:i});if(ge.webgpu.validateInputContent&&Zs(r,a),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Js(r,a))}}),to,ro,Id,qf=M(()=>{te(),re(),to=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},ro=e=>{let t=e[0].dims,r=e[0].dims[2],i=O.size(t)/4,a=e[0].dataType,n=B("input",a,t,4),s=B("bias",a,[r],4),l=B("residual",a,t,4),d=G("output",a,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:p=>`
  ...
  }`}},Id=e=>{to(e.inputs),e.compute(ro(e.inputs))}}),io,ue,Ed,Td,Cd,zd,Ad,Od,Rd,Bd,Dd,ao,Md,Pd,Ud,Nd,Yt,Wd,kr,qd,Vd,Hd,jd,Gd,Fd,Ld,Kd,Yd,Xd,Qd,Zd,Jd,ep,tp,rp,vi,ip,Ji,ea,ap,np,sp,no,so,op,_a=M(()=>{Y(),te(),be(),re(),io=(e,t,r,i,a,n,s)=>{let l=Math.ceil(t/4),d="";typeof a=="string"?d=`${a}(a)`:d=a("a");let p=B("inputData",r,[l],4),c=G("outputData",i,[l],4),u=[{name:"vec_size",type:"u32"}];return s&&u.push(...s),`
  ...
  }`},ue=(e,t,r,i,a,n=e.dataType,s,l)=>{let d=[{type:12,data:Math.ceil(O.size(e.dims)/4)}];return s&&d.push(...s),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:p=>io(p,O.size(e.dims),e.dataType,n,r,i,l),getRunData:p=>({outputs:[{dims:e.dims,dataType:n}],dispatchGroup:{x:Math.ceil(O.size(p[0].dims)/64/4)},programUniforms:d})}},Ed=e=>{e.compute(ue(e.inputs[0],"Abs","abs"))},Td=e=>{e.compute(ue(e.inputs[0],"Acos","acos"))},Cd=e=>{e.compute(ue(e.inputs[0],"Acosh","acosh"))},zd=e=>{e.compute(ue(e.inputs[0],"Asin","asin"))},Ad=e=>{e.compute(ue(e.inputs[0],"Asinh","asinh"))},Od=e=>{e.compute(ue(e.inputs[0],"Atan","atan"))},Rd=e=>{e.compute(ue(e.inputs[0],"Atanh","atanh"))},Bd=e=>ce(e),Dd=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(ue(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},ao=e=>{let t,r,i=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=i?e[1].getFloat32Array()[0]:-34028234663852886e22,r=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=i?e[1].getUint16Array()[0]:64511,r=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return ce({min:t,max:r})},Md=(e,t)=>{let r=t||ao(e.inputs),i=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${i}>(uniforms.min), vec4<${i}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:i},{name:"max",type:i}]),{inputs:[0]})},Pd=e=>{e.compute(ue(e.inputs[0],"Ceil","ceil"))},Ud=e=>{e.compute(ue(e.inputs[0],"Cos","cos"))},Nd=e=>{e.compute(ue(e.inputs[0],"Cosh","cosh"))},Yt=e=>ce(e),Wd=(e,t)=>{let r=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"Elu",i=>`elu_vf32(${i})`,`
...
}`,qd=e=>{let t=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,kr(t)))},Vd=e=>{e.compute(ue(e.inputs[0],"Exp","exp"))},Hd=e=>{e.compute(ue(e.inputs[0],"Floor","floor"))},jd=e=>{let t=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,kr(t)))},Gd=(e,t)=>{let r=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"LeakyRelu",i=>`select(leaky_relu_alpha_ * ${i}, ${i}, ${i} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Fd=e=>{e.compute(ue(e.inputs[0],"Not",t=>`!${t}`))},Ld=e=>{e.compute(ue(e.inputs[0],"Neg",t=>`-${t}`))},Kd=e=>{e.compute(ue(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Yd=e=>{let t=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Xd=e=>{e.compute(ue(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Qd=e=>ce(e),Zd=(e,t)=>{let r=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"HardSigmoid",i=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${i} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},Jd=e=>{e.compute(ue(e.inputs[0],"Sin","sin"))},ep=e=>{e.compute(ue(e.inputs[0],"Sinh","sinh"))},tp=e=>{e.compute(ue(e.inputs[0],"Sqrt","sqrt"))},rp=e=>{e.compute(ue(e.inputs[0],"Tan","tan"))},vi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,ip=e=>{e.compute(ue(e.inputs[0],"Tanh",vi))},Ji=(e="f32")=>`
...
`,ea=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,ap=e=>{let t=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"FastGelu",ea,Ji(t),void 0,e.inputs[0].dataType))},np=(e,t)=>{let r=Te(e.inputs[0].dataType);return e.compute(ue(e.inputs[0],"ThresholdedRelu",i=>`select(vec4<${r}>(0.0), ${i}, ${i} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},sp=e=>{e.compute(ue(e.inputs[0],"Log","log"))},no=(e,t)=>`
...
`,so=e=>`quick_gelu_impl(${e})`,op=(e,t)=>{let r=Te(e.inputs[0].dataType);e.compute(ue(e.inputs[0],"QuickGelu",so,no(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),oo,uo,up,Vf=M(()=>{te(),re(),_a(),oo=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},uo=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=B("input",e[0].dataType,e[0].dims,4),i=B("bias",e[0].dataType,[e[0].dims[2]],4),a=G("output",e[0].dataType,t,4),n=O.size(t)/4,s=ve(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:l=>`
  ...
  ${l.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},fp=e=>{je(e,"Sub",(t,r)=>`${t}-${r}`)},mp=e=>{je(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},gp=e=>{je(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},yp=e=>{je(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},$p=e=>{je(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}}),ho,co,fo,mo,wp,bp,jf=M(()=>{Y(),te(),be(),re(),ho=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,i=e[r],a=i.dataType,n=i.dims.length;e.forEach((s,l)=>{if(l!==r){if(s.dataType!==a)throw new Error("input tensors should be one type");if(s.dims.length!==n)throw new Error("input tensors should have the same shape");s.dims.forEach((d,p)=>{if(p!==t&&d!==i.dims[p])throw new Error("non concat dimensions must match")})}})},co=(e,t)=>`
...
`)},mo=(e,t,r,i)=>{let a=O.size(r),n=new Array(e.length),s=new Array(e.length),l=0,d=[],p=[],c=[{type:12,data:a}];for(let y=0;y<e.length;++y)l+=e[y].dims[t],n[y]=l,p.push(e[y].dims.length),s[y]=B(`input${y}`,i,p[y]),d.push("rank"),c.push({type:12,data:n[y]});for(let y=0;y<e.length;++y)c.push(...j(e[y].dims));c.push(...j(r));let u=G("output",i,r.length),m=u.indicesGet("indices",t),g=Array.from(Array(n.length).keys()).map(y=>`uniforms.sizeInConcatAxis${y}`).join(","),$=y=>`
  ...
  ${y.mainStart()}
    ...
    ${fo(s,u)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:r,dataType:i}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:$}},wp=(e,t)=>{let r=e.inputs,i=r[0].dims,a=O.normalizeAxis(t.axis,i.length);ho(r,a);let n=i.slice();n[a]=r.reduce((l,d)=>l+(d.dims.length>a?d.dims[a]:0),0);let s=r.filter(l=>O.size(l.dims)>0);e.compute(mo(s,a,n,r[0].dataType),{inputs:s})},bp=e=>ce({axis:e.axis})}),ht,ct,ft,va,gt=M(()=>{Y(),te(),ht=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},ct=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},ft=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},va=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[r,i]=e?.activation_params||[.2,.5];return{activation:t,alpha:r,beta:i}}else if(t==="Clip"){let[r,i]=e?.activation_params||[Ql,Zl];return{activation:t,clipMax:i,clipMin:r}}else if(t==="LeakyRelu"){let[r]=e?.activation_params||[.01];return{activation:t,alpha:r}}return{activation:t}}}),Ce,xa,Pr=M(()=>{Ce=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},xa=e=>`
...
bIndices[${b-2}] = u32(row);
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${u}`,inputDependencies:$},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:g}),getShaderSource:y}},Ip=(e,t,r,i)=>{let a=e.length>2,n=_e(r[3]),s=_e(r[2]),l=O.size(r)/n/s,d=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/n],p=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/n],c=[r[0],r[1],r[2],r[3]/n],u=[{type:12,data:l},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];ct(t,u),u.push(...j(d,p,c));let m=(s-1)*t.strides[1]+p[1],g=$=>{let y=G("output",e[0].dataType,c.length,n),x=ve(y.type.tensor),v=ht(t,y.type.value,x),b=B("x",e[0].dataType,d.length,n),S=B("w",e[1].dataType,p.length,n),k=[b,S];a&&k.push(B("b",e[2].dataType,e[2].dims,n));let E=a?"value += b[output_channel];":"",C=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return ft(t,C),`
...
`}return ne};return`
  ...
  ${n?S:k}}`},aa=(e,t,r)=>{let i=e.length>2,a=t.outputShape,n=O.size(a),s=[Math.ceil(n/64),1,1];we("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${s}`);let l=t.format==="NHWC",d=["rank","rank"],p=[t.strides[0],t.strides[1]],c=[t.kernelShape[l?1:2],t.kernelShape[l?2:3]],u=[t.dilations[0],t.dilations[1]],m=[c[0]+(t.dilations[0]<=1?0:(t.kernelShape[l?1:2]-1)*(t.dilations[0]-1)),c[1]+(t.dilations[1]<=1?0:(t.kernelShape[l?2:3]-1)*(t.dilations[1]-1))],g=[m[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),m[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],$=!1,y=t.group,x=e[1].dims,v=x[0]/y,b=x[1],S=[{type:12,data:n},{type:12,data:p},{type:12,data:c},{type:12,data:u},{type:12,data:m},{type:6,data:g},{type:12,data:v},{type:12,data:b},...j(e[0].dims,e[1].dims)];i&&(S.push(...j(e[2].dims)),d.push("rank")),S.push(...j(a));let k=s[1]===1&&s[2]===1,E=C=>{let z=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:p.length},{name:"filter_dims",type:"u32",length:c.length},{name:"dilations",type:"u32",length:c.length},{name:"effective_filter_dims",type:"u32",length:m.length},{name:"pads",type:"i32",length:g.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],P=ve(e[0].dataType);return`${zo(C,e,a,i,k,$,P,z,l)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:d},getRunData:()=>({dispatchGroup:{x:s[0],y:s[1],z:s[2]},outputs:[{dims:r?r(a):a,dataType:e[0].dataType}],programUniforms:S}),getShaderSource:E}}}),Ao,Oo,Ro,Ei,zp,Bo,Do,Mo,Po,Ap,Qf=M(()=>{Yf(),Xf(),gt(),Pt(),Ao=(e,t,r,i,a,n)=>(e-1)*t+r+(i-1)*a+1-n,Oo=(e,t,r,i,a)=>{let n=Math.floor(e/2);t==="SAME_UPPER"?(r[i]=n,r[a]=e-n):t==="SAME_LOWER"&&(r[i]=e-n,r[a]=n)},Ro=(e,t,r,i,a,n,s,l,d,p)=>{let c=e.length-2,u=p.length===0;if(d.length===0)for(let $=0;$<c;++$)d.push(0);let m=e[0],g=t[l?3:1]*a;for(let $=0,y=e.length-c-(l?1:0);$<c;++$,++y){let x=e[y],v=u?x*s[$]:p[$],b=Ao(x,s[$],n[$],t[y],r[$],v);Oo(b,i,n,$,$+c),u&&p.push(s[$]*(x-1)+d[$]+(t[y]-1)*r[$]+1-n[$]-n[$+c])}p.splice(0,0,m),p.splice(l?3:1,0,g)},Ei=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((u,m)=>u*m,1)===0){r.length=0;for(let u=2;u<t[1].dims.length;++u)r.push(t[1].dims[u])}let i=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(i?3:1,0,t[1].dims[1]);let a=e.pads.slice(),n=e.outputShape.slice(),s=e.outputPadding.slice(),l=t[0].dims,d=e.dilations.slice();if(d.reduce((u,m)=>u+m,0)===0){let u=t[0].dims.length-2;d=new Array(u).fill(1)}let p=e.strides.slice();if(p.reduce((u,m)=>u+m,0)===0){let u=t[0].dims.length-2;p=new Array(u).fill(1)}Ro(l,r,d,e.autoPad,e.group,a,p,i,s,n);let c=Object.assign({},e);return Object.assign(c,{kernelShape:r,pads:a,outputPadding:s,outputShape:n,dilations:d,strides:p}),c},zp=e=>{let t=va(e),r=e.format,i=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],a=e.dilations,n=e.group,s=e.kernelShape,l=e.pads,d=e.strides,p=e.wIsConst(),c=e.outputPadding,u=e.outputShape;return{autoPad:i,format:r,dilations:a,group:n,kernelShape:s,outputPadding:c,outputShape:u,pads:l,strides:d,wIsConst:p,...t,cacheKey:`${e.format};${t.activation};`}},Bo=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],i=e[1].dims[0];if(r!==i)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let a=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==a))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.reduce((s,l)=>s+l,0)>0&&t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.reduce((s,l)=>s+l,0)>0&&t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.reduce((s,l)=>s+l,0)>0&&t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.outputPadding.length!==n&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${n}D`);if(t.kernelShape.reduce((s,l)=>s+l,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Do=[2,3,1,0],Mo=(e,t,r)=>{let i=Ei(r,t),a=r.format==="NHWC",n=i.outputShape,s=n[a?3:1],l=t[0].dims[a?3:1];if(i.group!==1||s===1&&l===1){e.compute(aa(t,i));return}let d=n[a?1:2],p=n[a?2:3],c=t[1].dims[2],u=t[1].dims[3],m=a?d*p:s,g=a?s:d*p,$=c*u*l,y=!0,x=e.kernelCustomData.wT??e.compute(Ze(t[1],Do),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=x);let v=[t[0],x],b=t.length===3;b&&(!a&&t[2].dims.length===1?v.push(t[2].reshape([t[2].dims[0],1,1])):v.push(t[2])),e.compute(Cp(v,i,n,m,g,$,b,y),{inputs:v})},Po=(e,t)=>{let r=t.format==="NHWC",i=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&i.push(e.inputs[2]);let a=t.kernelShape;(a.length===0||a[0]===0)&&(a=[e.inputs[1].dims[2]]);let n=t.dilations;(n.length===0||n[0]===0)&&(n=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let l=t.pads;l.length===0&&(l=[0,0]),l=[0,l[0],0,l[1]],s=[1].concat(s),n=[1].concat(n),a=[1].concat(a);let d=Ei({...t,pads:l,strides:s,dilations:n,kernelShape:a},i);e.compute(aa(i,d,p=>r?[p[0],p[2],p[3]]:[p[0],p[1],p[3]]))},Ap=(e,t)=>{Bo(e.inputs,t),e.inputs[0].dims.length===3?Po(e,t):Mo(e,e.inputs,t)}}),Uo,Op,Rp,Zf=M(()=>{Y(),te(),be(),re(),Uo=(e,t,r,i)=>{let a=O.size(t),n=t.length,s=B("input",e,n),l=G("output",e,n),d=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),p=O.normalizeAxis(d,n),c=u=>{let m=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,g=H("uniforms.input_shape","uniforms.axis",n),$=i.reverse?m+(i.exclusive?" + 1":""):"0",y=i.reverse?g:m+(i.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:i.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},{type:12,data:p},...j(t,t)]}),getShaderSource:c}},Op=(e,t)=>{let r=e.inputs[0].dims,i=e.inputs[0].dataType,a=e.inputs[1];e.compute(Uo(i,r,a,t),{inputs:[0]})},Rp=e=>{let t=e.exclusive===1,r=e.reverse===1;return ce({exclusive:t,reverse:r})}}),No,Wo,qo,Bp,Dp,Jf=M(()=>{Y(),te(),be(),re(),No=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Wo=(e,t,r,i)=>{let a=[];a.push(`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let n=0;n<t;++n)a.push(r.indicesSet("a",e[n],`i[${n}]`));return a.push("return a;}"),a.join(`
...
`)};
    ...
    ${m}`},d=[{type:12,data:s},...j(t,i)];return{name:"Expand",shaderCache:{hint:`${i.length}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d})}},Up=e=>{Lo(e.inputs),e.compute(Yo(e.inputs),{inputs:[0]})}}),Xo,Np,rm=M(()=>{Y(),te(),re(),_a(),Xo=e=>{let t=e[0].dataType,r=O.size(e[0].dims),i=O.size(e[1].dims),a=i%4===0,n=s=>{let l=B("x",t,[1],4),d=B("bias",t,[1],4),p=G("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],u=g=>`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((g,$)=>$!==1).map(g=>g.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(g,$)=>"rank")},getRunData:()=>({outputs:[{dims:l,dataType:p}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:u}),getShaderSource:m}},Vp=(e,t)=>{let r=e.inputs;Jo(r,t),e.compute(eu(e.inputs,t))},Hp=e=>ce({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),tu,ru,jp,Gp,nm=M(()=>{Y(),te(),be(),re(),tu=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  ${E.mainStart([u,i.kvNumHeads,1])}
    ...
    ${S}
  }`;return{name:"ConcatPastNew",shaderCache:{hint:`${i.kvNumHeads}${u}${!!t}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:m,programUniforms:$}),getShaderSource:k}},Jp=e=>ce({...e}),du=ce({perm:[0,2,1,3]}),Bi=(e,t,r,i,a)=>{let n=t,s=i.kvNumHeads,l=i.nReps;return t.dims.length===3&&i.kvSequenceLength!==0&&(n=t.reshape([i.batchSize,i.kvSequenceLength,s,i.headSize])),r?n=e.compute(Ri(n,r,n.dataType,i),{inputs:[n,r],outputs:[i.isPastkvBSNH?a:-1]})[0]:n=e.compute(Ri(n,void 0,n.dataType,i),{inputs:[n],outputs:[i.isPastkvBSNH?a:-1]})[0],l!==1&&(n=e.compute(na([n],[1,1,1,l]),{inputs:[n],outputs:[-1]})[0],n=n.reshape([i.batchSize,i.totalSequenceLength,s*l,i.headSize])),e.compute(Ze(n,du.perm),{inputs:[n],outputs:[-1]})[0]},eh=(e,t)=>{let r=lu(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let i=Xt(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,e.inputs[0],void 0,0),a=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,n=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,s=Bi(e,e.inputs[1],a,r,1),l=Bi(e,e.inputs[2],n,r,2);Zt(e,i,s,l,void 0,void 0,void 0,void 0,void 0,r,t)}}),pu,hu,cu,th,um=M(()=>{Y(),te(),re(),pu=(e,t)=>{let r=e[0].dims,i=r,a=2,n=O.sizeToDimension(r,a),s=O.sizeFromDimension(r,a),l=_e(s),d=s/l,p=[r[0],r[1],d],c=["rank","type","type"],u=[{type:12,data:s},{type:12,data:d}];u.push(...j(p,p));let m=g=>{let $=B("x",e[0].dataType,p.length,l),y=B("scale",e[1].dataType,e[1].dims),x=B("bias",e[2].dataType,e[2].dims),v=G("output",e[0].dataType,p.length,l),b=[$,y,x,v],S=$.type.value,k=l===1?"f32":`vec${l}<f32>`,E=64,C=[{name:"normSize",type:"u32"},{name:"normPackedSize",type:"u32"}];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${d}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:c}),getShaderSource:g},{inputs:[t[0],m]})},th=(e,t)=>{t.format==="NHWC"?cu(e,e.inputs,t):e.compute(pu(e.inputs,t))}}),fu,mu,rh,lm=M(()=>{Y(),te(),re(),fu=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},mu=(e,t,r)=>{let i=t.simplified,a=e[0].dims,n=e[1],s=!i&&e[2],l=a,d=O.normalizeAxis(t.axis,a.length),p=O.sizeToDimension(a,d),c=O.sizeFromDimension(a,d),u=O.size(n.dims),m=s?O.size(s.dims):0;if(u!==c||s&&m!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  ${E.mainStart()}
    ...
    ${b?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${u};${m};${g};${y};${v}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:$,dataType:c}],dispatchGroup:{x},programUniforms:b}),getShaderSource:C}},ih=(e,t)=>{gu(e.inputs,t),e.compute(yu(e.inputs,t))},ah=e=>ce(e)}),$u,wu,bu,_u,vu,xu,Su,ku,nh,pm=M(()=>{Y(),te(),re(),$u=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},wu=(e,t,r)=>{let i="";for(let a=t-1;a>=0;--a)i+=`
    ...
    `,l="",d=B("x",t.dataType,t.dims.length),p=["rank"],[c,u,m,g,$]=Mi(n,a);return c.push(...j(t.dims,n)),{name:e,shaderCache:{hint:`${i.cacheKey};${m};${g};${$}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(n)/64)},programUniforms:c}),getShaderSource:y=>Pi(y,d,t.dims.length,n.length,a,s,l,t.dataType===10?-65504:-1e5,u,m,g,$)}},dh=(e,t)=>{Ht(e.inputs),e.compute(Vi("MaxPool",e.inputs[0],!1,t))},ph=e=>{let t=e.storage_order,r=e.dilations,i=Ni(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");i.ceilMode;let a={storageOrder:t,dilations:r,...i,cacheKey:""};return{...a,cacheKey:Eu(a)}},hh=e=>{let t=e.format;return{format:t,...qi,cacheKey:t}},ch=(e,t)=>{Ht(e.inputs),e.compute(Vi("GlobalMaxPool",e.inputs[0],!0,t))}}),Tu,Cu,fh,mh,cm=M(()=>{Y(),te(),be(),re(),Tu=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Cu=(e,t)=>{let r=O.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,a=i===3,n=e[0].dims,s=e[1].dataType,l=O.size(n),d=i===3||i===2,p=d?[Math.ceil(O.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,u=e.length>2?e[2]:void 0,m=u?d?[Math.ceil(O.size(u.dims)/4)]:u.dims:void 0,g=c.length===0||c.length===1&&c[0]===1,$=g===!1&&c.length===1,y=_e(l),x=g&&(!d||y===4),v=x?y:1,b=x&&!d?y:1,S=B("input",d?12:i,p.length,b),k=B("scale",s,c.length),E=u?B("zero_point",d?12:i,m.length):void 0,C=G("output",s,n.length,v),z=[S,k];E&&z.push(E);let P=[p,c];u&&P.push(m);let q=[{type:12,data:l/v},{type:12,data:r},{type:12,data:t.blockSize},...j(...P,n)],W=J=>{let Q=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:E?["rank","rank","rank"]:["rank","rank"]},getShaderSource:W,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(l/v/64),y:1,z:1},programUniforms:q})}},fh=(e,t)=>{Tu(e.inputs,t),e.compute(Cu(e.inputs,t))},mh=e=>ce({axis:e.axis,blockSize:e.blockSize})}),zu,Au,gh,fm=M(()=>{Le(),Y(),re(),zu=(e,t,r)=>{let i=e===t,a=e<t&&r<0,n=e>t&&r>0;if(i||a||n)throw new Error("Range these inputs' contents are invalid.")},Au=(e,t,r,i)=>{let a=Math.abs(Math.ceil((t-e)/r)),n=[a],s=a,l=[{type:12,data:s},{type:i,data:e},{type:i,data:r},...j(n)],d=p=>{let c=G("output",i,n.length),u=c.type.value,m=[{name:"outputSize",type:"u32"},{name:"start",type:u},{name:"delta",type:u}];return`
        ${p.registerUniforms(m).declareVariables(c)}
        ${p.mainStart()}
        ${p.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${u}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${i}`},getShaderSource:d,getRunData:()=>({outputs:[{dims:n,dataType:i}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:l})}},gh=e=>{let t=0,r=0,i=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],i=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],i=e.inputs[2].getFloat32Array()[0]),ge.webgpu.validateInputContent&&zu(t,r,i),e.compute(Au(t,r,i,e.inputs[0].dataType),{inputs:[]})}}),Ou,Ru,Bu,Du,Mu,Pu,Uu,Nu,Wu,qu,Vu,Hi,Hu,ju,Gu,Fu,Lu,yh,$h,mm=M(()=>{Y(),te(),be(),re(),Ou=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`},k=[{dims:l,dataType:e[0].dataType}];return r>1&&k.push({dims:c,dataType:1}),r>2&&k.push({dims:c,dataType:1}),r>3&&k.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${v};${g};${$};${y}`,inputDependencies:e.map((E,C)=>"type")},getShaderSource:S,getRunData:()=>({outputs:k,dispatchGroup:{x:Math.ceil(d/p)},programUniforms:b})}},bh=(e,t)=>{Xu(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Qu(e.inputs,t,e.outputCount,!1),{outputs:r})}}),Zu,jt,Ju,ji,el,tl,_h,vh,$m=M(()=>{Y(),te(),be(),re(),Zu=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,i)=>{if(e[i+1].dataType!==6&&e[i+1].dataType!==7)throw new Error(`Input ${i} must be an array of int32 or int64`)})},jt=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(i=>r.push(Number(i)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(i=>r.push(Number(i)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Ju=(e,t)=>{if(e.length>1){let r=jt(e,1),i=jt(e,2),a=jt(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),ce({starts:r,ends:i,axes:a})}else return t},ji=(e,t,r,i,a)=>{let n=e;return e<0&&(n+=r[i[t]]),a[t]<0?Math.max(0,Math.min(n,r[i[t]]-1)):Math.max(0,Math.min(n,r[i[t]]))},el=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${d}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:l},programUniforms:[{type:6,data:p}]}),getShaderSource:y}},xh=(e,t)=>{rl(e.inputs),e.compute(il(e.inputs[0],t))},Sh=e=>ce({axis:e.axis})}),al,nl,sl,ol,ul,kh,Ih,bm=M(()=>{Y(),te(),be(),re(),al=e=>{if(!e||e.length<1)throw new Error("too few inputs")},nl=(e,t)=>{let r=[],i=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),i=r.length),ce({numOutputs:i,axis:t.axis,splitSizes:r})},sl=e=>`
 ...
 * limitations under the License.
 * =============================================================================
 */export{Oe as O,ge as b,Bl as h};
